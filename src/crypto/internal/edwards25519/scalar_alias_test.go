...
func TestScalarAliasing(t *testing.T) {
	...
	for name, f := range map[string]interface{}{
		...
		"MultiplyAdd1": func(v, x, y, fixed Scalar) bool {
			return checkAliasingTwoArgs(func { v, x, y -> return v.MultiplyAdd(&fixed, x, y) }, v, x, y)
		},
		"MultiplyAdd2": func(v, x, y, fixed Scalar) bool {
			return checkAliasingTwoArgs(func { v, x, y -> return v.MultiplyAdd(x, &fixed, y) }, v, x, y)
		},
		"MultiplyAdd3": func(v, x, y, fixed Scalar) bool {
			return checkAliasingTwoArgs(func { v, x, y -> return v.MultiplyAdd(x, y, &fixed) }, v, x, y)
		},
	} {
