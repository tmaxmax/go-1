...
func TestReadImports(t *testing.T) {
	testRead(t, readImportsTests, func { r | return ReadImports(r, true, nil) })
}
...
func TestReadFailures(t *testing.T) {
	...
	testRead(t, readFailuresTests, func { r | return ReadImports(r, true, nil) })
}
...
func TestReadFailuresIgnored(t *testing.T) {
	...
	testRead(t, tests, func { r | return ReadImports(r, false, nil) })
}
