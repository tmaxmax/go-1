...
func TestMatchPattern(t *testing.T) {
	testPatterns(t, "MatchPattern", matchPatternTests, func { pattern, name | return MatchPattern(pattern)(name) })
}
...
func TestSimpleMatchPattern(t *testing.T) {
	testPatterns(t, "MatchSimplePattern", matchSimplePatternTests, func { pattern, name | return MatchSimplePattern(pattern)(name) })
}
...
func TestTreeCanMatchPattern(t *testing.T) {
	testPatterns(t, "TreeCanMatchPattern", treeCanMatchPatternTests, func { pattern, name | return TreeCanMatchPattern(pattern)(name) })
}
