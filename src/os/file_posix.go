...
func chmod(name string, mode FileMode) error {
	...
	e := ignoringEINTR(func { return syscall.Chmod(longName, syscallMode(mode)) })
	if e != nil {
...
func Chown(name string, uid, gid int) error {
	e := ignoringEINTR(func { return syscall.Chown(name, uid, gid) })
	if e != nil {
...
func Lchown(name string, uid, gid int) error {
	e := ignoringEINTR(func { return syscall.Lchown(name, uid, gid) })
	if e != nil {
