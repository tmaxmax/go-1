...
func TestAddSubUint(t *testing.T) {
	...
	for _, a := range []struct{ x, y, c, z, cout uint }{
		...
		test("Add intrinsic", func { x, y, c | Add(x, y, c) }, a.x, a.y, a.c, a.z, a.cout)
		test("Add intrinsic symmetric", func { x, y, c | Add(x, y, c) }, a.y, a.x, a.c, a.z, a.cout)
		test("Sub intrinsic", func { x, y, c | Sub(x, y, c) }, a.z, a.x, a.c, a.y, a.cout)
		test("Sub intrinsic symmetric", func { x, y, c | Sub(x, y, c) }, a.z, a.y, a.c, a.x, a.cout)
...
func TestAddSubUint64(t *testing.T) {
	...
	for _, a := range []struct{ x, y, c, z, cout uint64 }{
		...
		// The above code can't test intrinsic implementation, because the passed function is not called directly.
		// The following code uses a closure to test the intrinsic version in case the function is intrinsified.
		test("Add64 intrinsic", func { x, y, c | Add64(x, y, c) }, a.x, a.y, a.c, a.z, a.cout)
		test("Add64 intrinsic symmetric", func { x, y, c | Add64(x, y, c) }, a.y, a.x, a.c, a.z, a.cout)
		test("Sub64 intrinsic", func { x, y, c | Sub64(x, y, c) }, a.z, a.x, a.c, a.y, a.cout)
		test("Sub64 intrinsic symmetric", func { x, y, c | Sub64(x, y, c) }, a.z, a.y, a.c, a.x, a.cout)
	}
}
...
func TestMulDiv(t *testing.T) {
	...
	for _, a := range []struct {
		...
		// The above code can't test intrinsic implementation, because the passed function is not called directly.
		// The following code uses a closure to test the intrinsic version in case the function is intrinsified.
		testMul("Mul intrinsic", func { x, y | Mul(x, y) }, a.x, a.y, a.hi, a.lo)
		testMul("Mul intrinsic symmetric", func { x, y | Mul(x, y) }, a.y, a.x, a.hi, a.lo)
		testDiv("Div intrinsic", func { hi, lo, y | Div(hi, lo, y) }, a.hi, a.lo+a.r, a.y, a.x, a.r)
		testDiv("Div intrinsic symmetric", func { hi, lo, y | Div(hi, lo, y) }, a.hi, a.lo+a.r, a.x, a.y, a.r)
	}
}
