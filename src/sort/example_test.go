...
func ExampleSlice() {
	...
	sort.Slice(people, func { i, j -> return people[i].Name < people[j].Name })
	fmt.Println("By name:", people)

	sort.Slice(people, func { i, j -> return people[i].Age < people[j].Age })
...
func ExampleSliceStable() {
	...
	sort.SliceStable(people, func { i, j -> return people[i].Name < people[j].Name })
	fmt.Println("By name:", people)

	// Sort by age preserving name order
	sort.SliceStable(people, func { i, j -> return people[i].Age < people[j].Age })
