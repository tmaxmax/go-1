...
func cgoLookupPort(ctx context.Context, network, service string) (port int, err error) {
	...
	return doBlockingWithCtx(ctx, network+"/"+service, func { return cgoLookupServicePort(&hints, network, service) })
}
...
func cgoLookupIP(ctx context.Context, network, name string) (addrs []IPAddr, err error) {
	return doBlockingWithCtx(ctx, name, func { return cgoLookupHostIP(network, name) })
}
...
func cgoLookupPTR(ctx context.Context, addr string) (names []string, err error) {
	...
	return doBlockingWithCtx(ctx, addr, func { return cgoLookupAddrPTR(addr, sa, salen) })
}
...
func resSearch(ctx context.Context, hostname string, rtype, class int) ([]dnsmessage.Resource, error) {
	return doBlockingWithCtx(ctx, hostname, func { return cgoResSearch(hostname, rtype, class) })
}
